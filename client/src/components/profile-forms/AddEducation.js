    ...
    <Fragment>
      ...
      <form class="form" onSubmit={onSubmit}>
        <div class="form-group">
          <input type="text" placeholder="School or Bootcamps" name="school" value={school} onChange={onChange} required />
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
         ...
         <div class="form-group">
          <p><input
            type="checkbox" name="current" checked={current} value={current}
            onChange={e => {
        ...
        {!toDateDisabled && (
          ...
          <input type="date" name="to" value={to} onChange={onChange}
            // disable={toDateDisabled ? 'disable' : ""}
          />
        </div>
        )}
        <div class="form-group">
